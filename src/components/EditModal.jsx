...
const EditModal = ({ destination }) => {
    const { _id, destinationName, country, imageUrl, duration, price, description, category, departureDate } = destination;
    ...
    return (
        <div>
            <Modal>
                <Button variant='outline' className="mt-5 mb-3 rounded-none"><BiEdit /> Edit</Button>
                <Modal.Backdrop>
